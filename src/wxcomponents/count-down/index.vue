<template>
<uni-shadow-root class="count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'count-down/index'
...
export default global['__wxComponents']['count-down/index']
</script>
