<template>
<uni-shadow-root class="cell-group-index"><view v-if="title" class="van-cell-group__title">
  {{ title }}
</view>
...
global['__wxRoute'] = 'cell-group/index'
...
export default global['__wxComponents']['cell-group/index']
</script>
