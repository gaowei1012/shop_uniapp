<template>
<uni-shadow-root class="rate-index"><view class="van-rate custom-class" @touchmove="onTouchMove">
...
export default global['__wxComponents']['rate/index']
</script>
