<template>
<uni-shadow-root class="picker-toolbar"><view v-if="showToolbar" class="van-picker__toolbar toolbar-class">
...
global['__wxRoute'] = 'picker/toolbar'

Component({})

export default global['__wxComponents']['picker/toolbar']
</script>
