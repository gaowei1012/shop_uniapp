<template>
<uni-shadow-root class="collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'collapse-item/index'
...
export default global['__wxComponents']['collapse-item/index']
</script>
