<template>
<uni-shadow-root class="progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = 'progress/index'
...
export default global['__wxComponents']['progress/index']
</script>
