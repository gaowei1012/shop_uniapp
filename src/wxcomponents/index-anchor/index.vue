<template>
<uni-shadow-root class="index-anchor-index"><view class="van-index-anchor-wrapper" :style="wrapperStyle">
...
global['__wxRoute'] = 'index-anchor/index'
...
export default global['__wxComponents']['index-anchor/index']
</script>
