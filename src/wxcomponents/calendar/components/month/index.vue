<template>
<uni-shadow-root class="calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = 'calendar/components/month/index'
...
export default global['__wxComponents']['calendar/components/month/index']
</script>
