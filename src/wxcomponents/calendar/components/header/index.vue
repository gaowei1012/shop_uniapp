<template>
<uni-shadow-root class="calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'calendar/components/header/index'
...
export default global['__wxComponents']['calendar/components/header/index']
</script>
