<template>
<uni-shadow-root class="panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
export default global['__wxComponents']['panel/index']
</script>
