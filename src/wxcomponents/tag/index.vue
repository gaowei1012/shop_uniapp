<template>
<uni-shadow-root class="tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
export default global['__wxComponents']['tag/index']
</script>
