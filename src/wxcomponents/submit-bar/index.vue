<template>
<uni-shadow-root class="submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'submit-bar/index'
...
export default global['__wxComponents']['submit-bar/index']
</script>
