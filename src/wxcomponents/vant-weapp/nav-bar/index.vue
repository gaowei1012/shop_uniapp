<template>
<uni-shadow-root class="vant-weapp-nav-bar-index"><view :class="'custom-class van-nav-bar '+(border ? 'van-hairline--bottom' : '')+' '+(fixed ? 'van-nav-bar--fixed' : '')" :style="'z-index: '+(zIndex)">
