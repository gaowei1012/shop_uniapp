<template>
<uni-shadow-root class="vant-weapp-badge-group-index"><view class="van-badge-group van-hairline--top-bottom custom-class">
  <slot></slot>
...
global['__wxRoute'] = 'vant-weapp/badge-group/index'
...
export default global['__wxComponents']['vant-weapp/badge-group/index']
</script>
