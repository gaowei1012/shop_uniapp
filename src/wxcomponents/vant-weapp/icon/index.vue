...
@font-face {
  ...
  src: url(https://img.yzcdn.cn/vant/vant-icon-6a2b1e.woff2) format("woff2"),
    url(https://img.yzcdn.cn/vant/vant-icon-6a2b1e.woff) format("woff"),
    url(https://img.yzcdn.cn/vant/vant-icon-6a2b1e.ttf) format("truetype");
}
.van-icon {
  position: relative;
