<template>
<uni-shadow-root class="skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = 'skeleton/index'
...
export default global['__wxComponents']['skeleton/index']
</script>
