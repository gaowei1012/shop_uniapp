<template>
<uni-shadow-root class="loading-index"><view :class="'custom-class '+(utils.bem('loading', { vertical }))">
...
global['__wxRoute'] = 'loading/index'
