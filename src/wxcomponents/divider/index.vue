<template>
<uni-shadow-root class="divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = 'divider/index'
...
export default global['__wxComponents']['divider/index']
</script>
