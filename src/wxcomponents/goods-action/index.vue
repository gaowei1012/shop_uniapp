<template>
<uni-shadow-root class="goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = 'goods-action/index'
...
export default global['__wxComponents']['goods-action/index']
</script>
