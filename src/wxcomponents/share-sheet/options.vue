<template>
<uni-shadow-root class="share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'share-sheet/options'
...
export default global['__wxComponents']['share-sheet/options']
</script>
