<template>
<uni-shadow-root class="sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
export default global['__wxComponents']['sticky/index']
</script>
